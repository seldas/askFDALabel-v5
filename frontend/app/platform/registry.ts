...
const LABEL_TOOLS: ToolDef[] = [
  ...
  },
  {
    ...
    accent: '#f97316',
    pattern: 'dots',
    href: (ctx) => labelRoute(primarySetId(ctx)!, 'pv-profile'),
  },
  {
    id: 'label-labeling-ae',
    name: 'LabelingAE(beta)',
    blurb: 'Safety annotations and adverse event extraction from external server.',
    iconId: 'pulse',
    kind: 'embedded',
    group: 'analyze',
    toolboxWorkflow: 'safety',
    ...
    accent: '#8b5cf6',
    pattern: 'dots',
    href: (ctx) => labelRoute(primarySetId(ctx)!, 'labeling-ae'),
  },
  {
