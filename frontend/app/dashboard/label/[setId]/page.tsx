  ...
  const toolsList = [
    {
      ...
      cardBg: 'linear-gradient(135deg, rgba(240, 249, 255, 0.85) 0%, rgba(224, 242, 254, 0.5) 100%)',
      cardBorder: 'rgba(2, 132, 199, 0.28)',
      cardShadow: '0 4px 16px rgba(2, 132, 199, 0.08)',
      badgeBg: 'linear-gradient(135deg, rgba(2, 132, 199, 0.2) 0%, rgba(56, 189, 248, 0.3) 100%)',
      badgeColor: '#0284c7',
      badgeBorder: '1px solid rgba(2, 132, 199, 0.35)',
      accentColor: '#0284c7',
    },
    {
      id: 'label-tox-dili',
      ...
      cardBg: 'linear-gradient(135deg, rgba(236, 254, 255, 0.85) 0%, rgba(207, 250, 254, 0.5) 100%)',
      cardBorder: 'rgba(8, 145, 178, 0.3)',
      cardShadow: '0 4px 16px rgba(8, 145, 178, 0.08)',
      badgeBg: 'linear-gradient(135deg, rgba(8, 145, 178, 0.2) 0%, rgba(6, 182, 212, 0.3) 100%)',
      badgeColor: '#0891b2',
      badgeBorder: '1px solid rgba(8, 145, 178, 0.35)',
      accentColor: '#0891b2',
    },
    {
      id: 'label-tox-dict',
      ...
      cardBg: 'linear-gradient(135deg, rgba(255, 241, 242, 0.85) 0%, rgba(254, 226, 226, 0.5) 100%)',
      cardBorder: 'rgba(225, 29, 72, 0.3)',
      cardShadow: '0 4px 16px rgba(225, 29, 72, 0.08)',
      badgeBg: 'linear-gradient(135deg, rgba(225, 29, 72, 0.2) 0%, rgba(244, 63, 94, 0.3) 100%)',
      badgeColor: '#e11d48',
      badgeBorder: '1px solid rgba(225, 29, 72, 0.35)',
      accentColor: '#e11d48',
    },
    {
      id: 'label-tox-diri',
      ...
      cardBg: 'linear-gradient(135deg, rgba(254, 243, 199, 0.75) 0%, rgba(253, 230, 138, 0.45) 100%)',
      cardBorder: 'rgba(217, 119, 6, 0.3)',
      cardShadow: '0 4px 16px rgba(217, 119, 6, 0.08)',
      badgeBg: 'linear-gradient(135deg, rgba(217, 119, 6, 0.2) 0%, rgba(245, 158, 11, 0.3) 100%)',
      badgeColor: '#d97706',
      badgeBorder: '1px solid rgba(217, 119, 6, 0.35)',
      accentColor: '#d97706',
    },
    {
      id: 'label-tox-pgx',
      ...
      cardBg: 'linear-gradient(135deg, rgba(245, 243, 255, 0.85) 0%, rgba(237, 233, 254, 0.5) 100%)',
      cardBorder: 'rgba(124, 58, 237, 0.3)',
      cardShadow: '0 4px 16px rgba(124, 58, 237, 0.08)',
      badgeBg: 'linear-gradient(135deg, rgba(124, 58, 237, 0.2) 0%, rgba(168, 85, 247, 0.3) 100%)',
      badgeColor: '#7c3aed',
      badgeBorder: '1px solid rgba(124, 58, 237, 0.35)',
      accentColor: '#7c3aed',
    },
    {
      id: 'label-examine',
      ...
      cardBg: 'linear-gradient(135deg, rgba(236, 253, 245, 0.85) 0%, rgba(209, 250, 229, 0.5) 100%)',
      cardBorder: 'rgba(16, 185, 129, 0.3)',
      cardShadow: '0 4px 16px rgba(16, 185, 129, 0.08)',
      badgeBg: 'linear-gradient(135deg, rgba(16, 185, 129, 0.2) 0%, rgba(52, 211, 153, 0.3) 100%)',
      badgeColor: '#059669',
    ...
    },
    {
      ...
      cardBg: 'linear-gradient(135deg, rgba(238, 242, 255, 0.85) 0%, rgba(224, 231, 255, 0.5) 100%)',
      cardBorder: 'rgba(79, 70, 229, 0.3)',
      cardShadow: '0 4px 16px rgba(79, 70, 229, 0.08)',
      badgeBg: 'linear-gradient(135deg, rgba(79, 70, 229, 0.2) 0%, rgba(129, 140, 248, 0.3) 100%)',
      badgeColor: '#4f46e5',
      badgeBorder: '1px solid rgba(79, 70, 229, 0.35)',
      accentColor: '#4f46e5',
    },
    {
      id: 'labelcomp',
      ...
      cardBg: 'linear-gradient(135deg, rgba(253, 244, 255, 0.85) 0%, rgba(245, 208, 254, 0.5) 100%)',
      cardBorder: 'rgba(217, 70, 239, 0.3)',
      cardShadow: '0 4px 16px rgba(217, 70, 239, 0.08)',
      badgeBg: 'linear-gradient(135deg, rgba(217, 70, 239, 0.2) 0%, rgba(240, 171, 252, 0.3) 100%)',
      badgeColor: '#c026d3',
      badgeBorder: '1px solid rgba(217, 70, 239, 0.35)',
      accentColor: '#c026d3',
    },
  ];
