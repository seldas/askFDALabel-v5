...
function ToolboxPanel({ setId, data }: { setId: string; data: any }) {
  ...
  const toolsList = [
    ...
    },
    {
      ...
      cardBg: 'radial-gradient(circle at 90% 10%, rgba(79, 70, 229, 0.2) 0%, transparent 45%), repeating-linear-gradient(60deg, rgba(79, 70, 229, 0.04) 0px, rgba(79, 70, 229, 0.04) 2px, transparent 2px, transparent 12px), linear-gradient(135deg, rgba(238, 242, 255, 0.92) 0%, rgba(224, 231, 255, 0.6) 100%)',
      bgSize: '100% 100%, 100% 100%, 100% 100%',
